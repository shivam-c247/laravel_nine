       ...
       <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Add User  {{-- | &nbsp;<a href="{{ route('profile.edit') }}" class="btn btn-primary">Edit Profile</a> --}}</h4>
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('admin.users.store') }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="name" value="{{$user->name ?? ''}}" class="form-control" id="fname" placeholder="First Name Here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="lname" class="col-sm-3 text-right control-label col-form-label">Email Address</label>
                                        <div class="col-sm-9">
                                            <input type="email" name="email" value="{{$user->email ?? ''}}" class="form-control" id="lname" placeholder="Email Here">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="confirm_password" class="form-control" id="lname" placeholder="Confirm Password Here">
                                        </div>
                                    </div>
                                   {{-- <div class="form-group row">
