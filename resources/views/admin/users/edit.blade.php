       ...
       <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Edit User  {{-- | &nbsp;<a href="{{ route('profile.edit') }}" class="btn btn-primary">Edit Profile</a> --}}</h4>
                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('admin.users.update',$user->id) }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" name="email" value="{{$user->email ?? ''}}" class="form-control" id="lname" placeholder="Last Name Here">
                                        </div>
                                    </div>
                           {{--          <div class="form-group row">
